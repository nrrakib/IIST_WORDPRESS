...
<head>
    ...
    <title>বাংলাদেশ ( Bangladesh ) জাতীয় তথ্য বাতায়ন</title>
    <?php wp_head(); ?>
    ...
    <section class="my_container">
      <div class="row logo">
          <div class="col-lg-5 logo_left">
              <a href='#'><img src="<?=get_template_directory_uri()?><?=get_template_directory_uri()?> ./assets/images/header/logo_bn.png" alt="">
          </div>
  ...
  <div class="row hero">
              ...
              <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                      <img src="<?=get_template_directory_uri()?>./assets/images/slider/Banner-1.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                      <img src="<?=get_template_directory_uri()?>./assets/images/slider/corona_banner.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                      <img src="<?=get_template_directory_uri()?>./assets/images/slider/pmobanner.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
          ...
          <div class="tab">
            ...
            <div class="tab-content" id="pills-tabContent">
              ...
              <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab" tabindex="0">
                <div class="row">
                  <div class="col-lg-2">
                    <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/service/agriculture.png" alt=""></a><br>
                      <a href="">কৃষি</a>
                  </div>

                  <div class="col-lg-2">
                    <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/service/call_center.png" alt=""></a><br>
                      <a href="">কল সেন্টার</a>
                  </div>
                  ...
                  <div class="col-lg-2">
                    <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/service/mobile_service.png" alt=""></a><br>
                      <a href="">মোবাইল সেবা</a>
                  </div>

                  <div class="col-lg-2">
                    <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/service/helpdesk.png" alt=""></a><br>
                      <a href="">হেল্পডেস্ক</a>
                  </div>
      ...
      <div class="col-lg-4 hero_side">
        <div class="side-image">
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/Bangladesh-Directory.jpg" class="d-block w-100 p-2" alt=""></a>
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/bangladesh-portal--batton-bangla.png" class="d-block w-100 p-2" alt=""></a>
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/discount_bn.jpg" class="d-block w-100 p-2" alt=""></a>
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/Jonotar-Sorkar-banner-Bangl (1).jpg" class="d-block w-100 p-2" alt=""></a>
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/mygov_bn.jpg" class="d-block w-100 p-2" alt=""></a>
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/prottyon.jpg" class="d-block w-100 p-2" alt=""></a>
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/Tamplate_Apps_bn (5).png" class="d-block w-100 p-2" alt=""></a>
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/Tamplate_Dictonary_bn.png" class="d-block w-100 p-2" alt=""></a>
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/Tamplate_DistrictBranding_b (3).png" class="d-block w-100 p-2" alt=""></a>
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/Tamplate_fund_bn.png" class="d-block w-100 p-2" alt=""></a>
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/Tamplate_govtjob_bn.png" class="d-block w-100 p-2" alt=""></a>
          <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/sidebar/Tamplate_guard_bn.png" class="d-block w-100 p-2" alt=""></a>
        </div>
        <!-- ===========side-video============ -->
        <div class="side-video-section">
          ...
          <div class="side-video">
            ...
            <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/mask-bd-portal (1).jpg" alt=""  class="d-block w-100"></a>
            <h6>ডেঙ্গু প্রতিরোধে করণীয়</h6>
            <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/dengu.jpg" alt="" class="d-block w-100"></a>
          </div>
        </div>
      </div>
  </div>
  ...
  <footer class="my_container">
    ...
    <div class="row footer-bottom">
      ...
      <div class="col-lg-5 fb-right text-end">
        ...
        <a href=""><img src="<?=get_template_directory_uri()?>./assets/images/footer/np-logo-set.png" alt=""></a>
      </div>
    </div>
  </footer>
